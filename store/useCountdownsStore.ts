    ...
    (set, get) => ({
      ...
      fetchCountdowns: async () => {
        ...
        try {
          ...
          set({ error: err instanceof Error ? err.message : 'Failed to fetch countdowns', isLoading: false });
        }
      },
      ...
      fetchCountdown: async (id: string) => {
        ...
        try {
          ...
          set({ error: err instanceof Error ? err.message : 'Failed to fetch countdown', isLoading: false });
        }
      },
      ...
      createCountdown: async (countdown) => {
        ...
        try {
          ...
          set({ error: err instanceof Error ? err.message : 'Failed to create countdown', isLoading: false });
        }
      },
      ...
      updateCountdown: async (id, updates) => {
        ...
        try {
          ...
          set((state) => ({
            countdowns: state.countdowns.map((c) => (c.id === id ? { ...c, ...updatedCountdown, ...countdownService.calculateDaysRemaining(updatedCountdown.target_date) } : c)),
            currentCountdown: state.currentCountdown?.id === id ? updatedCountdown : state.currentCountdown,
            isLoading: false,
          }));
        } catch (err) {
          set({ error: err instanceof Error ? err.message : 'Failed to update countdown', isLoading: false });
        }
      },
      ...
      deleteCountdown: async (id) => {
        ...
        try {
          ...
          set((state) => ({
            ...
            currentCountdown: state.currentCountdown?.id === id ? null : state.currentCountdown,
            isLoading: false,
          }));
        } catch (err) {
          set({ error: err instanceof Error ? err.message : 'Failed to delete countdown', isLoading: false });
        }
      },
      ...
      markComplete: async (id) => {
        ...
        try {
          ...
          set({ error: err instanceof Error ? err.message : 'Failed to mark countdown complete', isLoading: false });
        }
      },
