...
import { Habit, HabitCompletion, HabitWithStats, HabitInsert, HabitUpdate } from '../types/habit';
...
export async function toggleHabitCompletion(
  ...
  if (completed) {
    ...
    if (error) throw error;
    return { id: '', habit_id: habitId, user_id: userId, date, completed: false, created_at: new Date().toISOString() };
  }
}
